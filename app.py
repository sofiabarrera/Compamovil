...
mysql=MySQL()
app.config['MYSQL_DATABASE_HOST']='db-mysql-nyc1-59254-do-user-14120281-0.b.db.ondigitalocean.com'
app.config['MYSQL_DATABASE_PORT']=25060
app.config['MYSQL_DATABASE_USER']='doadmin'
app.config['MYSQL_DATABASE_PASSWORD']='AVNS_d7iL2uGXwTusSSqAHhP'
